...
/*const sendVerificationEmail = async (toEmail, firstName) => {
    const mssg = {
        to: toEmail,
        from: 'jsneary@eagles.bridgewater.edu',
...
const sendVerificationEmail = (toEmail, username, token) => {
    sendOneButtonEmail({
        to: toEmail,
        from: { name: 'The Study Buddy', email: 'jsneary@eagles.bridgewater.edu' },
        subject: 'Welcome to The Study Buddy!',
        imgURL: 'http://cdn.mcauto-images-production.sendgrid.net/d082bc91880cf0be/d245d721-6ac2-40c6-a11a-a2563deaad3b/647x580.jpg',
        firstLine: `Thanks for signing up, ${username}!`,
        secondLine: 'Please verify your email address to begin studying with buddies.',
        thirdLine: 'Thank you!',
        buttonURL: `https://orange-grass-0859d9b0f.4.azurestaticapps.net/verify.html?token=${token}`,
